...
if grep -qF -- 'style Img fill:#fdf5e0,stroke:#f4ead0,stroke-width:2px' <<<"$OUTPUT_CONTENT"; then echo "  ✅ 18: start block endpoint style preserved"; PASS=$((PASS+1)); else echo "  ❌ 18: start block endpoint style MISSING"; FAIL=$((FAIL+1)); fi
if grep -qF -- 'style Control fill:#fdf5e0,stroke:#f4ead0,stroke-width:2px' <<<"$OUTPUT_CONTENT"; then echo "  ✅ 18: end block endpoint style preserved"; PASS=$((PASS+1)); else echo "  ❌ 18: end block endpoint style MISSING"; FAIL=$((FAIL+1)); fi
